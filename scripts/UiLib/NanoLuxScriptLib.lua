...
function Library:Create(xHubName,xGameName)
    ...
    TabHolder.Position = UDim2.new(0.234827583, 0, 0.054, 0) -- Moved lower from 0.024
    TabHolder.Size = UDim2.new(0, 424, 0, 490) -- Increased height
    ...
    function xTabs:Tab(Name,xVisible)
        ...
        Tab.Size = UDim2.new(0, 424, 0, 490) -- Increased height
